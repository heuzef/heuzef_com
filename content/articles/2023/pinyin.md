...
Dans le cadre de mon apprentissage du chinois mandarin, j'ai développé un petit outil qui offre un clavier Pinyin en ligne.
...
Et pour ceux qui souhaitent récupérer le code source, pour héberger leur propre instance ou l'utiliser hors-ligne, vous pouvez récupérer ça **[<i class="fa fa-link"></i> ICI](https://github.com/heuzef/pinyin)**.
